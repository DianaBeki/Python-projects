#useful to check if someone has entered right email
...
password = "Dina# regular expressions, useful when doing validation, i'e password, email
import re
string = 'search inside of this text please!'
print('search' in string) # True
